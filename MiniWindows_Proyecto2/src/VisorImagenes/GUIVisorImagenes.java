...
public class GUIVisorImagenes extends JFrame {
    ...
    private JPanel crearPanelHerramientas() {
        ...
        lblRotarIzq.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) { rotarIzquierda(); }
        });
        ...
        lblRotarDer.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) { rotarDerecha(); }
        });
    ...
    private JLabel crearOpcionInteractiva(String texto) {
        ...
        lbl.setOpaque(false); // Sin fondo opaco
        lbl.setBorder(BorderFactory.createEmptyBorder(6, 10, 6, 10));
        
        lbl.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                // Solo cambiar color de texto, sin fondo
    ...
    private JButton crearBotonNavegacion(String texto) {
        ...
        btn.addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                if (btn.isEnabled()) {
                    btn.setBackground(new Color(0, 95, 184));
                }
            }
    ...
    private void ajustarPantalla() {
        int anchoVentana = scrollPane.getViewport().getWidth() - 40;
        int altoVentana = scrollPane.getViewport().getHeight() - 40;
    ...
    private void actualizarInformacion() {
        ...
        if (archivo != null) {
            ...
            String info = String.format("%d × %d px  •  %s  •  Zoom: %.0f%%", 
                ancho, alto, formatearTamanio(tamanio), visor.getZoomActual() * 100);
